...
BOOST_AUTO_TEST_CASE(thinblock_test) {
    ...
    BOOST_CHECK(xthinblock.vMissingTx.size() >= 8 && thinblock.vMissingTx.size() <= 9);
    ...
    BOOST_CHECK(xthinblock1.vMissingTx.size() >= 8 && thinblock1.vMissingTx.size() <= 9);
    ...
    BOOST_CHECK(thinblock2.vMissingTx.size() >= 7 && thinblock2.vMissingTx.size() <= 9);
    BOOST_CHECK(xthinblock2.vMissingTx.size() >= 7 && thinblock2.vMissingTx.size() <= 9);
