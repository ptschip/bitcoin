...
class ParallelTest (BitcoinTestFramework):
    ...
    def setup_network(self, split=False):
        self.nodes = []
        self.nodes.append(start_node(0, self.options.tmpdir, ["-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(2, self.options.tmpdir, ["-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(3, self.options.tmpdir, ["-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
    ...
    def run_test (self):
        ...
        self.nodes = []
        self.nodes.append(start_node(0, self.options.tmpdir, ["-par=2", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-par=2", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(2, self.options.tmpdir, ["-par=2", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(3, self.options.tmpdir, ["-par=2", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        ...
        self.nodes.append(start_node(0, self.options.tmpdir, ["-par=1", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0", "-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-par=1", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(2, self.options.tmpdir, ["-par=1", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(3, self.options.tmpdir, ["-par=1", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        self.nodes.append(start_node(4, self.options.tmpdir, ["-par=1", "-rpcworkqueue=64", "-rpcthreads=16", "-rpcservertimeout=0","-debug", "-use-thinblocks=0", "-excessiveblocksize=6000000", "-blockprioritysize=6000000", "-blockmaxsize=6000000"]))
        ...
        # Mine a block on node 4 and 5 and then mine 100 to age them such that they are spendable.
